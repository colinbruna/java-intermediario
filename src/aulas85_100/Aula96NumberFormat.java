...
public class Aula96NumberFormat {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        porcent.setMaximumIntegerDigits(7); //máximo de casas inteiras
        porcent.setMinimumIntegerDigits(5); //mínimo de casas inteiras

        porcent.setMaximumFractionDigits(2); //máximo de casas decimais
        porcent.setMinimumFractionDigits(1); //minimo de casas decimais

        porcentagem = porcent.format(99.9875385);
        System.out.println(porcentagem);
        ...
        nf.setRoundingMode(RoundingMode.UP); //arredondando pra mais
        nf.setMaximumFractionDigits(0);
        nf.setMinimumFractionDigits(0);
        System.out.println(nf.format(99.50));

        Number num3 = nf.parse("100,00");
        System.out.println(num3.intValue()); //só a parte inteira do número
    }
}