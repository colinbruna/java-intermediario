...
public class Aula88GregorianCalendar {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(hoje.isLeapYear(2024)); //verificando se o ano é bissexto

        System.out.println("----");

        //opções de construtores
        GregorianCalendar hoje2 = new GregorianCalendar(2022, 1, 16);

        imprimirData(hoje2);

        GregorianCalendar hoje3 = new GregorianCalendar(2022, 1, 16, 20, 36, 00);
